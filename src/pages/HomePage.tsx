...
export default function HomePage() {
  ...
  const c = language === 'fr' ? {
    reserve: 'Réserver une table', order: 'Commander en ligne', heroNote: 'Cuisine indienne & pakistanaise, chaleureuse et généreuse au cœur de Montparnasse.',
    dishesKicker: 'Les signatures', dishesTitle: 'Des plats qui racontent une histoire', dishesIntro: 'Une première sélection pour donner le ton de notre carte, présentée sans photographie pendant cette étape créative.', storyKicker: 'L’esprit de la maison', storyTitle: 'Une cuisine de partage, façonnée par la tradition', story: `À ${BRAND_NAME}, les cuissons lentes, le tandoor et les épices composent une cuisine vivante. Chaque service célèbre la générosité et l’hospitalité au cœur de Montparnasse.`, storyLink: 'Découvrir notre histoire',
    galleryKicker: 'L’univers', galleryTitle: 'Une atmosphère à découvrir', galleryIntro: 'La future galerie réunira les gestes, les détails de la salle et les assiettes de la maison.', galleryLink: 'Voir la galerie', finalKicker: 'Votre table à Montparnasse', finalTitle: 'Venez partager un moment généreux', finalText: 'Réservez votre table ou contactez-nous pour préparer votre visite.', contact: 'Nous contacter', footer: 'Cuisine indienne & pakistanaise · Paris 14e'
  } : {
    reserve: 'Book a table', order: 'Order online', heroNote: 'Warm, generous Indian & Pakistani cuisine in the heart of Montparnasse.',
    dishesKicker: 'Signatures', dishesTitle: 'Dishes that tell a story', dishesIntro: 'A first selection setting the tone of our menu, presented without photography during this creative approval stage.', storyKicker: 'The spirit of the house', storyTitle: 'Food for sharing, shaped by tradition', story: `At ${BRAND_NAME}, slow cooking, the tandoor and fragrant spices create vibrant cuisine. Every service celebrates generosity and hospitality in the heart of Montparnasse.`, storyLink: 'Discover our story',
    galleryKicker: 'The experience', galleryTitle: 'An atmosphere to discover', galleryIntro: 'The future gallery will bring together craft, dining-room details and the dishes of the house.', galleryLink: 'View the gallery', finalKicker: 'Your table in Montparnasse', finalTitle: 'Come and share a generous moment', finalText: 'Book your table or contact us to plan your visit.', contact: 'Contact us', footer: 'Indian & Pakistani cuisine · Paris 14th'
  };
  ...
  return <div className="home-approval">
    <section className="home-approval-hero home-approval-hero-cinematic">
      <div className="home-approval-hero-ornament" aria-hidden="true"><span>✦</span><i /><i /><i /></div>
      <div className="home-approval-hero-shade" aria-hidden="true" />
      <motion.p className="home-approval-hero-note" initial={reduceMotion ? false : { opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .65, delay: .38 }}>{c.heroNote}</motion.p>
